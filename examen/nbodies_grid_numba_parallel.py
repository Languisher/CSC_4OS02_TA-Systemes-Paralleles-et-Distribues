# Étape "Parallélisation en numba du code séquentiel"
# Variante parallèle construite à partir de nbodies_grid_numba.py
# en gardant le fichier original intact.
import sys
...
@njit(parallel=True)
def update_stars_cell_properties(
    ...
    n_cells_total = cell_masses.shape[0]
    for i in prange(n_cells_total):
        cell_mass = 0.0
...
if __name__ == "__main__":
    ...
    print(f"Simulation parallèle de {filename} avec dt = {dt} et grille {n_cells_per_dir}")
