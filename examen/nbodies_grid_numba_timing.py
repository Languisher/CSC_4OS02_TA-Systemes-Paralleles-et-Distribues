# Étape "Mesure du temps initial"
# Variante dédiée aux mesures, construite à partir de nbodies_grid_numba.py
# en gardant le fichier original intact.
import sys

import numpy as np
import visualizer3d_timed as visualizer3d
...
def run_simulation(
    ...
    visu.run(updater=update_positions, dt=dt, max_frames=max_frames, metrics_callback=metrics_callback)
